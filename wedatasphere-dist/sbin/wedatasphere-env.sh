...
HADOOP_HOME=/data/opt/cloudera/parcels/CDH/lib/hadoop
HADOOP_CONF_DIR=/wedatasphere/config/hadoop-config
YARN_RESTFUL_URL=http://wds10
HIVE_HOME=/data/opt/cloudera/parcels/CDH/lib/hive
HIVE_CONF_DIR=/wedatasphere/config/hive-config
HADOOP_CLASSPATH=`hadoop classpath`
HIVE_META_URL=jdbc:mysql://wds07:3305/metastore?useUnicode=true
HIVE_META_USER=hive
